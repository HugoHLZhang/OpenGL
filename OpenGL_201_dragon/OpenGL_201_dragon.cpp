...
struct Application
{
    ...
    bool Initialize()
    {
        ...
        m_textureShader.LoadVertexShader("basic_vertex3d.vs.glsl");
        m_textureShader.LoadFragmentShader("basic_texture.fs.glsl");
...
//-x  <--+--> +x
    ...
    void Render()
    {
        ...
        float rotationY_homogene4D[] = { cosf(temps), 0.f, -sinf(temps), 0.0f,
                                0.f, 1.f, 0.f, 0.f,
                                sinf(temps), 0.f, cosf(temps), 0.f,
                                0.f, 0.f, 0.f, 1.f
        };
        
        const int32_t ROTATION = glGetUniformLocation(program, "u_RotationMatrix");
        glUniformMatrix4fv(ROTATION, 1, false, rotationY_homogene4D);

        float translation_homogene4D[] = { 
                                1.f, 0.f, 0.f, 0.f,
                                0.f, 1.f, 0.f, 0.f,
                                0.f, 0.f, 1.f, 0.f,
                                0.f, -3.f, -12.f, 1.f
        ...
        const int32_t TRANSLATION = glGetUniformLocation(program, "u_TranslationMatrix");
        glUniformMatrix4fv(TRANSLATION, 1, false, translation_homogene4D);
